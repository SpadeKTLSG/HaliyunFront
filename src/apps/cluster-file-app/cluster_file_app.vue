<template>
  ...
  <div class="cluster_file_app">

    <!--应用标识-->
    <el-text class="base_header">群组文件</el-text>

  </div>

  <!--左侧导航区域-->
  <div class="cluster_file_app_left_nav">
  ...
  <!--具体页面-->
  <component :is="currentView" class="cluster_file_app_compo" @close="backAppHome"/>
